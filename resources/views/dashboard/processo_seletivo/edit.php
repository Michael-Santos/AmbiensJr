            ...
            <div class="border px-3 py-3 my-2 rounded">
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check-descricao">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check-pdf" {{ $processo_seletivo->exibe_pdf() }}>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check-link" {{ $processo_seletivo->exibe_link() }}>
